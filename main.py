...
class VentanaPrincipal(QMainWindow): 
    def __init__(self): 
        ...
        self.pushButton_python_descargar.clicked.connect(self.descargar_python_espacio)
    ...
    def cambio_img_trabajo(self):
        ...
        self.img_trabajo = self.img_original if self.radioButton_img_original.isChecked() else self.img_ruido
    ...
    def descargar_python_espacio(self):
        self.descargar_img(self.img_python_resultado, 'python_espacio')
